...
const products = [
   ...
   },
   {
      ...
      description: "Zig Zag Stone interlock bricks are built for durability and style. Made from high-grade concrete, ideal for driveways and walkways. Dimensions: 100 * 200 * 60mm.",
      dimensions: "100 * 200 * 60mm"
   },
   {
      id: 6,
      name: 'Durance Stone',
      image: '/Img/product/pro-6.png',
      description: "Durance Stone interlock bricks combine elegance and strength. Made from reinforced concrete, perfect for outdoor decor. Dimensions: 180 * 180 * 60mm.",
